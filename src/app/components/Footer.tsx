...
export default function Footer() {
  ...
  const handleSubscribe = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Save subscriber to localStorage (local device list)
      ...
      console.error("Failed to subscribe in footer", error);
      setStatus('error');
    }
  };
      ...
      <div className="site-footer">
        ...
        <div className="footer-left-col">
          ...
          <div className="newsletter-form-container" style={{ width: '100%', maxWidth: '440px', marginBottom: '2.25rem' }}>
            <h4 style={{ fontFamily: "'Canela Text', 'Canela', Georgia, serif", fontSize: '1.15rem', fontWeight: '500', color: 'var(--primary-color)', marginBottom: '0.4rem' }}>
              Subscribe to the Newsletter
            </h4>
            <p style={{ fontFamily: "var(--font-lato), 'Lato', sans-serif", fontSize: '0.85rem', color: 'var(--text-muted)', marginBottom: '1rem', lineHeight: '1.5' }}>
          ...
          <div className="footer-socials">
            {/* LinkedIn */}
            <a
              href="https://linkedin.com/in/drhephzitagoe"
              target="_blank"
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/dr.hanat"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-link"
            ...
            {/* YouTube */}
            <a
              href="https://www.youtube.com/@Hanat_akordor"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-link"
              aria-label="YouTube"
            ...
            {/* TikTok */}
            <a
              href="https://tiktok.com/@dr.hanat"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-link"
              aria-label="TikTok"
            ...
            {/* Facebook */}
            <a
              href="https://www.facebook.com/HanatAkordor"
              target="_blank"
              rel="noopener noreferrer"
              className="footer-social-link"
              aria-label="Facebook"
        ...
        <div className="footer-right-col">
          ...
          <ul className="footer-link-list">
            <li>
              <Link href="/about" className="footer-link-item" style={{ textDecoration: 'none' }}>
                About Dr. Hephzi
              </Link>
            </li>
            <li>
